...
preloadExpressions = false, preloadMotions = false, onPreloadComplete, onPreloadProgress, ariaLabel, ariaDescription, enableKeyboardControls = false, onKeyboardEvent, }) => {
    ...
    const breathingTimerRef = React.useRef(null);
    const mousePositionRef = React.useRef({ x: 0, y: 0 });
    const currentAngleRef = React.useRef({ x: 0, y: 0 });
    const performanceRef = React.useRef({ frameCount: 0, startTime: 0 });
...
exports.Live2DCharacter = Live2DCharacter;
exports.useLive2DAudio = useLive2DAudio;
